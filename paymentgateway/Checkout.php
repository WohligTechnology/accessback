...
$order_id=$_POST['orderid'];        //your script should substitute the order description here in the quotes provided here
$url="http://localhost/accesssback/index.php/json/payumoneysuccess?orderid=".$_POST['orderid'];         //your redirect URL where your customer will be redirected after authorisation from CCAvenue
$billing_cust_name=$_POST['firstname'];
...
$delivery_city=$_POST['shippingcity'];
