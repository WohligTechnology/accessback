			   ...
			   <?php foreach($table as $row) { ?>
					<tr>
						...
						<td> <a class="btn btn-primary btn-xs" href="<?php echo site_url('site/editnewarrival?id=').$row->newarrivalid;?>"><i class="icon-pencil"></i></a>
                                      <a onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-xs" href="<?php echo site_url('site/deletenewarrival?id=').$row->newarrivalid; ?>"><i class="icon-trash "></i></a>
